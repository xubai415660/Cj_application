...
<template>
  <div class="approval">
    <!-- 查询部分 -->
    <ami-card class="approval-Inquire">
    ...
    <div class="approval-table">
      <div class="content">
        ...
        >
          ...
          <!-- 底部按钮 -->
          <div slot="bottom">
            <ami-button round :type="examineShow ? 'primary' : ''" @click="handleAudit()">正式版发布审核</ami-button>
          </div>
          <!-- 应用名称 -->
...
export default {
  ...
  computed: {
    ...mapGetters(["approval_examine", "approval_classify"]),
  },
  methods: {
