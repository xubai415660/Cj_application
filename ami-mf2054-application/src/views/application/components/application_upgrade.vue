 ...
 * @description: 版本升级申请
 * @author: 王浩
 * @Date: 2023-01-02 11:54:40
 * @Modified By: --
 * @version: 1.0.0
-->
<template>
  <ami-card class="upgrade">
    <!--头部 -->
    <div class="header">
    ...
    <div class="imprint">
      ...
      <ami-form ref="form" :model="ruleForm" :rules="rules" label-width="100px">
        <ami-row>
          <ami-col :span="6">
    ...
    <div class="defect-source">
      ...
      <div class="transfer-table">
        <div v-if="page2.tableTotal" style="height: calc(100% - 10px)">
          <ami-table
            border
            stripe
            class="tables"
