  ...
  <div>
    <div class="uploader-container">
      ...
      <input
        ...
        @change="fileChosen"
      />
      <img v-if="uploadStatus === 'n'" alt="" class="upload-img-btn" src="./assets/upload.png" @click="openFileWindow()" />
      ...
      <div style="text-align: center">
        ...
        <div style="height: 10px">&nbsp;</div>
        <a
          v-if="config.isMultiple && fileList.length > 0 && fileList.length < config.fileQuantityLimit && uploadStatus === 'w'"
          class="pointer link"
